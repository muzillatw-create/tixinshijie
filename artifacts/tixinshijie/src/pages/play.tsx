...
const data: ArticleDarkData = {
  ...
  sections: [
    ...
    {
      id: "play-series13",
      h2: "🎒【玩】漫畫系列｜玩，是探索世界的方式，也是讓生活更精彩的魔法",
      content: [
        "背上背包去旅行探險，流汗運動感覺真好，和朋友打球享受團隊合作，露營野炊看星星，衝浪玩水清涼刺激，在遊樂園笑聲不斷，三五好友桌遊歡笑不停，沉浸電玩世界享受成就感——每一種玩法，都讓生活更加精彩。",
        "玩出精彩，玩出快樂，讓每一天都充滿美好的回憶！生活，就是要好好玩！",
        "✨幸福時光｜吃喝玩樂",
        "每一天，都值得留下最美好的回憶。",
      ],
      imageAfter: true,

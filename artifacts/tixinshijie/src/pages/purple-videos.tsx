  ...
  return (
    <Layout>
      <div className="max-w-6xl mx-auto px-4 py-20 min-h-[80vh]">
        ...
        <div className="mb-10 bg-purple-500/5 border border-purple-500/20 rounded-2xl p-6 max-w-2xl mx-auto text-center">
          <h2 className="text-xl font-bold text-purple-400 mb-3">使用說明</h2>
          <p className="text-lg font-semibold text-gray-200">貼片適合貼在包裝盒外部</p>
        </div>
